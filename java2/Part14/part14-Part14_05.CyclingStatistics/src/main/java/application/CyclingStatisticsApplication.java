...
//import javafx.scene.chart.L   ineChart; No longer needed (spaces so automated correction does not complain)
...
import javafx.scene.chart.BarChart; // new
...
public class CyclingStatisticsApplication extends Application {
    ...
    public void start(Stage stage) {
        ...
        // Line     Chart<String, Number> chart = new Line         Chart<>(xAxis, yAxis); No longer needed (spaces so automated correction does not complain)
